    ...
    for (let i = 0; i < balls.length; i++) {
        for (let j = i + 1; j < balls.length; j++) {
            ...
            if (dist < ballSize) {
                ...
                const nx = (ball2.x - ball1.x) / dist;
                const ny = (ball2.y - ball1.y) / dist;
                ...
                // Update nextX and nextY for proper wall collision detection
                ball1.nextX = ball1.x + ball1.velocityX;
                ball1.nextY = ball1.y + ball1.velocityY;
                ball2.nextX = ball2.x + ball2.velocityX;
                ball2.nextY = ball2.y + ball2.velocityY;
            }
        }
    }
}
